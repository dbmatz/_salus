                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item">
                                    <form action="/logout" method="POST">
                                        @csrf
                                        <button id="button-sair" type="submit" class="dropdown-item"
                                            aria-current="page">Sair</button>
                                    </form>
                                </a>
                            </div>
                        </li>
...
<!-- <footer>
    <img src="{{ asset('css/flor-maracuja.png') }}" alt="">
    <img src="{{ asset('css/IFMS.png') }}" alt="">
</footer> -->
